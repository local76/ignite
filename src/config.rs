//! ignite application configuration — backed by library's `AppConfig<T>`.
//!
...
pub const CONFIG_HEADER: &str = "ignite Local Configuration\n-----------------------------";

/// Concrete configuration fields for ignite.
#[derive(Debug, Clone)]
